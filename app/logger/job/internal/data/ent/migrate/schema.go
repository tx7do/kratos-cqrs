...
var (
	...
	SensorDataColumns = []*schema.Column{
		...
		{Name: "temperature", Type: field.TypeFloat64, SchemaType: map[string]string{"mysql": "DOUBLE", "postgres": "DOUBLE PRECISION"}},
		{Name: "cpu", Type: field.TypeFloat64, SchemaType: map[string]string{"mysql": "DOUBLE", "postgres": "DOUBLE PRECISION"}},
	}
