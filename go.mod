...
require (
	...
	github.com/go-kratos/kratos/contrib/config/etcd/v2 v2.0.0-20221216030104-facafba64ad4
	...
	github.com/tx7do/kratos-transport v0.0.0-20220806094112-02553ebbf14c
